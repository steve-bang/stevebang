---
title: "What Is JWT and Why Should .NET Developers Care? - JWT #1"
...
keywords: ['JWT', ' JSON Web Token', ' .NET authentication', ' ASP.NET Core security', ' token-based authentication', ' JWT in .NET', ' JWT advantages', ' .NET developer guide', ' stateless authentication', ' API security']
author: "Steve Bang"
...
# Next steps 
- [Anatomy of a JWT — Header, Payload, Signature](/blog/jwt-anatomy-header-payload-signature)