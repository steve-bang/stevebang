...
keywords: [".NET", "Central Package Management .NET", "NuGet dependency management", "Directory.Packages.props", "VersionOverride", "GlobalPackageReference", "Transitive Pinning", "dotnet", "dotnet tips", "how to use central package management", "CPM .NET example", "migrate to central package management"]
author: "Steve Bang"
